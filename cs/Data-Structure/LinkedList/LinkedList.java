public class Main {
    ...
    static class LinkedList {
            ...
            if (data.equals(preNode.getData())) {
                ...
                while(tempNode != null) {
                    ...
                    if(data.equals(tempNode.getData())) {
                        if(tempNode.link == null) { // tempNode가 마지막 노드인 경우
                            preNode.link = null;
                        } else { //tempNode가 마지막 노드가 아닌 경우
        ...
        public void deleteNode() {
            ...
            // head 노드가 null인 경우 모든 노드가 삭제되었으므로 return(종료)
            if (head == null) {
                return;
            }
            ...
            if (head.link == null) {
                ...
                // tempNode의 link가 null이 아닐 때 까지 한 노드씩 다음 노드로 이동.
    ...
    public static void main(String[] args) {
        ...
        LinkedList linkedList = new LinkedList();   //직접 만든 연결리스트 생성
